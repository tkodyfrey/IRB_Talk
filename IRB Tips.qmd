...
format: 
  revealjs:
    ...
    preview-links: auto
    logo: images/UK.png
    footer: <tkfr222@uky.edu> | [tkodyfrey.github.io](tkodyfrey.github.io)
    scrollable: true
    transition: fade
...
::: nonincremental
-   Quant Methods / Survey Researcher
-   Instructional Comm Scholar
...
I've tried to make this super practical, so if you have a protocol you are working on (or would like to start), I encourage you to work as we go.

If you want to hold a discussion about the ethics involved in human subjects research, we can do that another time. My goal is to help you submit a protocol and respond to feedback.
...
Minimal risk: "the probability and magnitude of harm or discomfort anticipated ... are not greater ... than those ordinarily encountered in daily life or during ... routine physical or psychological examinations or tests."
...
2.  What do I need to actually include?
...
![](images/ORI%20Homepage.png) ::: notes I don't really prepare anything beforehand. Just start the protocol. Do this with them. :::

## Starting Your Protocol

Let's build a new application.

![](images/New%20Protocol%20App.png)

If you expect it to include minimal risk, speak with faculty member or Don first.
...
##  {background-iframe="https://ris.uky.edu/irb/Dashboard/PI/PIDashboard.aspx" background-interactive="true"}
...
![](images/helme.jpeg){.absolute bottom="85" right="320" width="400" height="400"}
...
Do what he asks unless there is a critical misunderstanding of what the project is about.

In any case, email to 1) thank for feedback and 2) explain your changes.

::: notes
They want to help but sometimes they just don't know the scope of what you are doing!
:::
...
##  {background-iframe="https://ris.uky.edu/irb/Dashboard/Login.aspx" background-interactive="true"}
...
1.  You will get IRB feedback likely in 2-3 weeks
2.  You will get an email saying that it has been screen and needs changes before going to the IRB.
