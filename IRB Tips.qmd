---
title: "CI664 Workshop: Navigating the IRB"
author: "Dr. T. Kody Frey"
subtitle: "Assistant Professor | School of Information Science | CI College Research Program Coordinator"
format: 
  revealjs:
    theme: [simple]
    slide-number: true
...
::: notes
I don't really prepare anything beforehand. You are welcome to start a protocol with me if you like / working through that process.
:::
...
::: notes
In my experience, qual research that more deeply examines individuals lived experieces typically does not get waived, but it can. 
:::
...
-   They tell you exactly how to set it up for approval.
...
-   The **P**rocess has several steps
-   The **P**arts are often repetitive
-   The **P**erson actually wants to see you succeed
